...
if(!$_SESSION["pedidos_id"]){
    header("Location: ../pedidos/1.formpedido.php");
    exit();
}
$idPedido = $_SESSION["pedidos_id"];

$sql = "SELECT carrito.productos_codigo,productos.nombre, productos.precio, carrito.cantidad, carrito.costototal FROM carrito INNER JOIN productos  ON carrito.productos_codigo = productos.codigo WHERE carrito.pedidos_id = '$idPedido'";
...
$sql = "SELECT c.productos_codigo, p.nombre, p.precio, c.cantidad, c.costototal
FROM carrito c 
...
<td><?php echo $fila["productos_codigo"]; ?></td>
...
<td>
    <a class="btn-eliminar" 
       href="eliminarcarrito.php?codigo=<?php echo $fila['productos_codigo']; ?>&idPedido=<?php echo $idPedido; ?>">
        Eliminar
    </a>
</td>
...
<a class="btn-finalizar" href="../pedidos/8.finalizarpedido.php?idPedido=<?php echo $idPedido; ?>"> Finalizar Pedido </a>
